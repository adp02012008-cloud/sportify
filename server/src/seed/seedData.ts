...
export const seedDatabase = async () => {
  console.log('🌱 Generating 50+ songs, 20+ artists, 20+ albums, 15+ playlists, 10+ podcasts, 10+ audiobooks...');
  ...
  const users = [
    {
      id: 'usr-admin',
      _id: 'usr-admin',
      name: 'SoundWave Admin',
      username: 'admin',
      email: 'admin@soundwave.io',
      password: adminPasswordHash,
      role: 'ADMIN',
      avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300&auto=format&fit=crop&q=80',
      bio: 'Lead System Administrator at SoundWave HQ.',
      likedSongs: ['song-1', 'song-4', 'song-10', 'song-13'],
      savedAlbums: ['alb-1', 'alb-3', 'alb-7'],
      followedArtists: ['art-1', 'art-3', 'art-7', 'art-9'],
      followingUsers: ['usr-alex', 'usr-premium'],
      plan: 'PREMIUM_YEARLY',
    ...
    },
    {
      ...
      name: 'Sarah Connor',
      username: 'sarah_hifi',
      email: 'premium@soundwave.io',
      password: passwordHash,
      role: 'PREMIUM_USER',
      avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=300&auto=format&fit=crop&q=80',
      bio: 'Audiophile & sound designer exploring 24-bit lossless streaming.',
      likedSongs: ['song-1', 'song-2', 'song-3', 'song-16'],
      savedAlbums: ['alb-1', 'alb-11'],
      followedArtists: ['art-1', 'art-11'],
      followingUsers: ['usr-admin'],
    ...
    },
    {
      ...
      bio: 'Midnight lo-fi enthusiast & acoustic guitar collector.',
      likedSongs: ['song-1', 'song-4', 'song-7', 'song-10', 'song-13', 'song-16'],
      savedAlbums: ['alb-1', 'alb-3', 'alb-7', 'alb-11'],
      followedArtists: ['art-1', 'art-3', 'art-7', 'art-9', 'art-11'],
  ...
  const artists = [
    ...
    },
    {
      ...
      topSongIds: ['song-25', 'song-26', 'song-40'],
      albumIds: ['alb-17']
    },
    {
      id: 'art-18',
    ...
    },
    {
      ...
      topSongIds: ['song-45', 'song-46'],
      albumIds: ['alb-21']
    }
  ];

  // 3. SEED SONGS (52 comprehensive songs)
  const songs = [
    // Electronic (1-3)
    {
      id: 'song-1',
      ...
      mood: 'Energetic',
      lyrics: [
        { timestamp: 0, text: '[Instrumental Synth Intro]' },
        { timestamp: 14, text: 'Driving down the cyber road tonight' },
        { timestamp: 28, text: 'Neon lights reflecting in the rain' },
        { timestamp: 42, text: 'Pushing speed into the endless grid' },
        { timestamp: 58, text: 'Catch the neon horizon before it fades' }
      ]
    },
    {
      id: 'song-2',
    ...
    // Pop (4-6)
    {
      ...
      mood: 'Uplifting',
      lyrics: [
        { timestamp: 0, text: '[Upbeat Guitar Chords]' },
        { timestamp: 12, text: 'Met you right beneath the golden glow' },
        { timestamp: 25, text: 'Dancing slow along the avenue' },
        { timestamp: 40, text: 'Never felt the world so bright and true' }
      ]
    },
    {
      id: 'song-5',
  ...
  // 4. SEED ALBUMS (21 albums)
  const albums = [
    { id: 'alb-1', title: 'Synthetic Dreams', artist: 'CyberPulse', artistId: 'art-1', releaseYear: 2024, genre: 'Electronic', artwork: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&auto=format&fit=crop&q=80', songIds: ['song-1', 'song-2', 'song-29', 'song-47'], durationStr: '14 min 11 sec', likesCount: '48,290' },
    { id: 'alb-2', title: 'Vapor Waveform', artist: 'Kroma Synth', artistId: 'art-2', releaseYear: 2023, genre: 'Electronic', artwork: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&auto=format&fit=crop&q=80', songIds: ['song-3', 'song-33'], durationStr: '7 min 26 sec', likesCount: '29,400' },
    { id: 'alb-3', title: 'Golden Hour Glow', artist: 'Aria Vance', artistId: 'art-3', releaseYear: 2024, genre: 'Pop', artwork: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600&auto=format&fit=crop&q=80', songIds: ['song-4', 'song-5', 'song-30', 'song-48'], durationStr: '13 min 03 sec', likesCount: '192,800' },
    { id: 'alb-4', title: 'Prism of Sound', artist: 'Luna Sterling', artistId: 'art-4', releaseYear: 2023, genre: 'Pop', artwork: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&auto=format&fit=crop&q=80', songIds: ['song-6'], durationStr: '3 min 12 sec', likesCount: '34,100' },
    { id: 'alb-5', title: 'Crown & Concrete', artist: 'King Cipher', artistId: 'art-5', releaseYear: 2023, genre: 'Hip-Hop', artwork: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=600&auto=format&fit=crop&q=80', songIds: ['song-7', 'song-8', 'song-49'], durationStr: '10 min 18 sec', likesCount: '88,900' },
    { id: 'alb-6', title: 'Underground Frequency', artist: 'Echo Flow', artistId: 'art-6', releaseYear: 2024, genre: 'Hip-Hop', artwork: 'https://images.unsplash.com/photo-1460723237483-7a6dc9d0b212?w=600&auto=format&fit=crop&q=80', songIds: ['song-9', 'song-35'], durationStr: '6 min 42 sec', likesCount: '21,500' },
    { id: 'alb-7', title: 'Surili Shaam', artist: 'Arijit Verma', artistId: 'art-7', releaseYear: 2024, genre: 'Bollywood', artwork: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&auto=format&fit=crop&q=80', songIds: ['song-10', 'song-11', 'song-32', 'song-50'], durationStr: '17 min 56 sec', likesCount: '342,000' },
    { id: 'alb-8', title: 'Rangrez', artist: 'Shreya Kapoor', artistId: 'art-8', releaseYear: 2023, genre: 'Bollywood', artwork: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&auto=format&fit=crop&q=80', songIds: ['song-12', 'song-36'], durationStr: '7 min 27 sec', likesCount: '76,400' },
    { id: 'alb-9', title: 'Chennai Beats', artist: 'Anirudh Sriram', artistId: 'art-9', releaseYear: 2024, genre: 'Tamil', artwork: 'https://images.unsplash.com/photo-1520523839898-507127027582?w=600&auto=format&fit=crop&q=80', songIds: ['song-13', 'song-14', 'song-34', 'song-51'], durationStr: '15 min 15 sec', likesCount: '218,000' },
    { id: 'alb-10', title: 'Thendral Raagam', artist: 'Harini Sundar', artistId: 'art-10', releaseYear: 2023, genre: 'Tamil', artwork: 'https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600&auto=format&fit=crop&q=80', songIds: ['song-15', 'song-37'], durationStr: '8 min 20 sec', likesCount: '41,200' },
    { id: 'alb-11', title: 'Warm Mug Sessions', artist: 'Coffee Bean Chords', artistId: 'art-11', releaseYear: 2024, genre: 'Lo-fi', artwork: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=600&auto=format&fit=crop&q=80', songIds: ['song-16', 'song-17', 'song-52'], durationStr: '8 min 02 sec', likesCount: '512,000' },
    { id: 'alb-12', title: 'Pastel Skies', artist: 'Lofi Sloth', artistId: 'art-12', releaseYear: 2023, genre: 'Lo-fi', artwork: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&auto=format&fit=crop&q=80', songIds: ['song-18', 'song-31'], durationStr: '5 min 14 sec', likesCount: '198,000' },
    { id: 'alb-13', title: 'Fossil & Flame', artist: 'The Iron Reverbs', artistId: 'art-13', releaseYear: 2023, genre: 'Rock', artwork: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=600&auto=format&fit=crop&q=80', songIds: ['song-19', 'song-20'], durationStr: '8 min 12 sec', likesCount: '62,700' },
    { id: 'alb-14', title: 'Overdrive Protocol', artist: 'Silver Distortion', artistId: 'art-14', releaseYear: 2024, genre: 'Rock', artwork: 'https://images.unsplash.com/photo-1511735111819-9a3f7709049c?w=600&auto=format&fit=crop&q=80', songIds: ['song-21', 'song-38'], durationStr: '7 min 43 sec', likesCount: '18,400' },
    { id: 'alb-15', title: 'Smoke & Bourbon', artist: 'Miles Henderson Quartet', artistId: 'art-15', releaseYear: 2023, genre: 'Jazz', artwork: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=600&auto=format&fit=crop&q=80', songIds: ['song-22', 'song-23'], durationStr: '9 min 55 sec', likesCount: '45,300' },
    { id: 'alb-16', title: 'Coffee & Clarinet', artist: 'Ella Laurent', artistId: 'art-16', releaseYear: 2024, genre: 'Jazz', artwork: 'https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?w=600&auto=format&fit=crop&q=80', songIds: ['song-24', 'song-39'], durationStr: '7 min 44 sec', likesCount: '39,100' },
    { id: 'alb-17', title: 'Midnight Piano Solos', artist: 'Vienna Chamber Collective', artistId: 'art-17', releaseYear: 2022, genre: 'Classical', artwork: 'https://images.unsplash.com/photo-1520523839898-507127027582?w=600&auto=format&fit=crop&q=80', songIds: ['song-25', 'song-26', 'song-40'], durationStr: '15 min 27 sec', likesCount: '94,000' },
    { id: 'alb-18', title: 'Pacific Folkways', artist: 'The Cedar Meadows', artistId: 'art-18', releaseYear: 2024, genre: 'Indie', artwork: 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600&auto=format&fit=crop&q=80', songIds: ['song-27', 'song-28'], durationStr: '6 min 47 sec', likesCount: '35,000' },
    { id: 'alb-19', title: 'Desert Caravan', artist: 'Rhythm of Sahara', artistId: 'art-19', releaseYear: 2023, genre: 'World', artwork: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&auto=format&fit=crop&q=80', songIds: ['song-41', 'song-42'], durationStr: '8 min 13 sec', likesCount: '28,000' },
    { id: 'alb-20', title: 'Nordic Deep', artist: 'Aurora Borealis Club', artistId: 'art-20', releaseYear: 2024, genre: 'Electronic', artwork: 'https://images.unsplash.com/photo-1517230878791-4d28214017c3?w=600&auto=format&fit=crop&q=80', songIds: ['song-43', 'song-44'], durationStr: '9 min 05 sec', likesCount: '52,000' },
    { id: 'alb-21', title: 'Bamboo Meditation', artist: 'Zen Garden Strings', artistId: 'art-21', releaseYear: 2023, genre: 'Classical', artwork: 'https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600&auto=format&fit=crop&q=80', songIds: ['song-45', 'song-46'], durationStr: '9 min 20 sec', likesCount: '67,000' }
  ];

  // 5. SEED PLAYLISTS (16 playlists including Blend & Collaborative)
  const playlists = [
    {
      id: 'pl-1',
      ...
      songIds: ['song-1', 'song-2', 'song-3', 'song-29', 'song-33', 'song-47'],
      followers: '840,290',
      accentColor: '#06b6d4',
      isPublic: true,
    ...
    },
    {
      ...
      songIds: ['song-16', 'song-17', 'song-18', 'song-31', 'song-52'],
      followers: '2,150,000',
      accentColor: '#10b981',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-10', 'song-11', 'song-12', 'song-32', 'song-36', 'song-50'],
      followers: '4,890,300',
      accentColor: '#ec4899',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-13', 'song-14', 'song-15', 'song-34', 'song-37', 'song-51'],
      followers: '3,210,000',
      accentColor: '#f59e0b',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-4', 'song-5', 'song-6', 'song-30', 'song-48'],
      followers: '1,980,000',
      accentColor: '#3b82f6',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-7', 'song-8', 'song-9', 'song-35', 'song-49'],
      followers: '1,420,000',
      accentColor: '#8b5cf6',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-22', 'song-23', 'song-24', 'song-39'],
      followers: '760,000',
      accentColor: '#d97706',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-19', 'song-20', 'song-21', 'song-38'],
      followers: '1,120,000',
      accentColor: '#ef4444',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      cover: 'https://images.unsplash.com/photo-1520523839898-507127027582?w=600&auto=format&fit=crop&q=80',
      songIds: ['song-25', 'song-26', 'song-40'],
      followers: '690,000',
      accentColor: '#6366f1',
      isPublic: true,
      isCollaborative: false
    ...
    },
    {
      ...
      songIds: ['song-1', 'song-4', 'song-16', 'song-10', 'song-43'],
      followers: '2',
      accentColor: '#ec4899',
      isPublic: true,
      isCollaborative: true,
      collaborators: ['usr-alex', 'usr-premium']
    },
    {
      id: 'pl-12',
      ...
      songIds: ['song-7', 'song-13', 'song-21', 'song-34', 'song-43'],
      followers: '1,560,000',
      accentColor: '#f43f5e',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      cover: 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600&auto=format&fit=crop&q=80',
      songIds: ['song-27', 'song-28', 'song-45', 'song-46'],
      followers: '920,000',
      accentColor: '#f59e0b',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-17', 'song-25', 'song-45'],
      followers: '1,840,000',
      accentColor: '#38bdf8',
      isPublic: true,
      isCollaborative: false
    },
    {
      ...
      songIds: ['song-3', 'song-6', 'song-9', 'song-14', 'song-20', 'song-29', 'song-44'],
      followers: 'Personal',
      accentColor: '#8b5cf6',
      isPublic: false,
      isCollaborative: false
  ...
  // 6. SEED PODCASTS (10+ Podcasts with 30+ Episodes)
  const podcasts = [
    {
      id: 'pod-1',
      ...
      followers: '340,000',
      episodes: [
        { id: 'ep-101', title: 'The Rise of Analog Synths in 2026', duration: 1840, durationStr: '30:40', releaseDate: '2024-03-01', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', description: 'Why modern bedroom producers are ditching pure digital plugins for analog voltage-controlled oscillators.' },
        { id: 'ep-102', title: 'Spatial Audio & Atmos Mixing Secrets', duration: 2150, durationStr: '35:50', releaseDate: '2024-03-08', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', description: 'How Dolby Atmos and binaural rendering transform stereo acoustics into three-dimensional soundstages.' },
        { id: 'ep-103', title: 'Mastering Lossless Hi-Fi Audio', duration: 1980, durationStr: '33:00', releaseDate: '2024-03-15', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', description: 'Understanding dynamic range, sample rates, dither, and FLAC compression for audiophile playback.' }
      ]
    },
    {
      id: 'pod-2',
      ...
      followers: '520,000',
      episodes: [
        { id: 'ep-201', title: 'Hans Zimmer & The Wall of Bass', duration: 2420, durationStr: '40:20', releaseDate: '2024-02-12', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', description: 'Deconstructing the seismic brass and Shepard tones behind iconic sci-fi blockbuster scores.' },
        { id: 'ep-202', title: 'Indian Cinema Scoring Revolutions', duration: 2280, durationStr: '38:00', releaseDate: '2024-02-26', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', description: 'From Rahman to Anirudh: How rhythm, folk orchestration, and rock riffs redefined multilingual cinema music.' },
        { id: 'ep-203', title: 'The Silence of Suspense', duration: 1920, durationStr: '32:00', releaseDate: '2024-03-10', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', description: 'Why negative space and room silence are often more terrifying than violent musical stabs.' }
      ]
    },
    {
      id: 'pod-3',
      ...
      followers: '890,000',
      episodes: [
        { id: 'ep-301', title: 'AI Audio Models & Generative Beats', duration: 1450, durationStr: '24:10', releaseDate: '2024-03-18', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', description: 'How generative diffusion models are helping independent creators produce royalty-free sample packs.' },
        { id: 'ep-302', title: 'Streaming Economics 2026', duration: 1600, durationStr: '26:40', releaseDate: '2024-03-19', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', description: 'A breakdown of user-centric payout models, merchandise bundles, and high-fidelity tier pricing.' },
        { id: 'ep-303', title: 'Building Mobile-First Global Products', duration: 1720, durationStr: '28:40', releaseDate: '2024-03-20', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', description: 'Designing frictionless mobile checkout, responsive gesture navigation, and low-latency client state.' }
      ]
    },
    {
      id: 'pod-4',
      ...
      followers: '670,000',
      episodes: [
        { id: 'ep-401', title: 'Binaural Beats & Brainwave Entrainment', duration: 1540, durationStr: '25:40', releaseDate: '2024-01-20', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', description: 'Do alpha and theta binaural frequencies actually enhance focus and deep states of calm?' },
        { id: 'ep-402', title: 'Overcoming Notification Fatigue', duration: 1800, durationStr: '30:00', releaseDate: '2024-02-05', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', description: 'Practical habits to reclaim cognitive clarity from endless push notifications and doomscrolling.' },
        { id: 'ep-403', title: '15-Minute Evening Wind Down Meditation', duration: 900, durationStr: '15:00', releaseDate: '2024-02-18', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', description: 'A relaxing vocal session with soft ambient pads designed to prepare the nervous system for sleep.' }
      ]
    },
    {
      id: 'pod-5',
      ...
      followers: '410,000',
      episodes: [
        { id: 'ep-501', title: 'Episode 1: The Phantom Protocol', duration: 2310, durationStr: '38:30', releaseDate: '2024-01-10', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', description: 'A renegade memory hacker discovers an encrypted consciousness in the city subway mainframe.' },
        { id: 'ep-502', title: 'Episode 2: Neon Alley Exchange', duration: 2450, durationStr: '40:50', releaseDate: '2024-01-24', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', description: 'Cornered by black-market cyber-mercenaries, Kira makes a dangerous trade for clean biometric credentials.' },
        { id: 'ep-503', title: 'Episode 3: Ghost in the Neural Core', duration: 2600, durationStr: '43:20', releaseDate: '2024-02-07', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', description: 'Infiltrating the high-altitude cloud server where the city artificial intelligence awakens.' }
      ]
    },
    {
      id: 'pod-6',
      ...
      followers: '780,000',
      episodes: [
        { id: 'ep-601', title: 'The Library of Alexandria Legends', duration: 2240, durationStr: '37:20', releaseDate: '2024-01-15', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', description: 'What scrolls and scientific wonders were actually preserved in the greatest intellectual beacon of the ancient Mediterranean.' },
        { id: 'ep-602', title: 'The Antikythera Mechanism Decoded', duration: 2100, durationStr: '35:00', releaseDate: '2024-02-01', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', description: 'How a corroded bronze artifact recovered from a Greek shipwreck proved the existence of an ancient astronomical computer.' },
        { id: 'ep-603', title: 'The Indus Valley Acoustic Architecture', duration: 1980, durationStr: '33:00', releaseDate: '2024-02-15', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', description: 'Exploring the urban layout, drainage systems, and ceremonial sound design of Mohenjo-Daro.' }
      ]
    },
    {
      id: 'pod-7',
      ...
      followers: '310,000',
      episodes: [
        { id: 'ep-701', title: 'The Geography of Spices: From Malabar to Mexico', duration: 1850, durationStr: '30:50', releaseDate: '2024-02-10', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', description: 'How black pepper, cardamom, and chili peppers shaped worldwide trade routes and national cuisines.' },
        { id: 'ep-702', title: 'The Ancient Art of Sourdough Wild Ferments', duration: 1950, durationStr: '32:30', releaseDate: '2024-02-24', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', description: 'Cultivating wild lactobacillus and yeast starters for artisanal bread with complex open crumbs.' },
        { id: 'ep-703', title: 'Tokyo Ramen Masters & 48-Hour Broths', duration: 2040, durationStr: '34:00', releaseDate: '2024-03-09', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', description: 'The obsessive precision of simmering dashi, tare, and tonkotsu stocks for ultimate umami depth.' }
      ]
    },
    {
      id: 'pod-8',
      ...
      followers: '620,000',
      episodes: [
        { id: 'ep-801', title: 'React 19 & The Modern Frontend Ecosystem', duration: 2150, durationStr: '35:50', releaseDate: '2024-02-14', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', description: 'Exploring Actions, compiler optimizations, hydration improvements, and modern state architecture.' },
        { id: 'ep-802', title: 'Building Low-Latency Audio Players on the Web', duration: 2400, durationStr: '40:00', releaseDate: '2024-02-28', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', description: 'Handling HTML5 audio streams, procedural synthesizer fallbacks, crossfade gain nodes, and memory management.' },
        { id: 'ep-803', title: 'Zero-Downtime Microservice Migrations', duration: 2280, durationStr: '38:00', releaseDate: '2024-03-14', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', description: 'How to refactor monolith databases into partitioned micro-stores without dropping user transactions.' }
      ]
    },
    {
      id: 'pod-9',
      ...
      followers: '940,000',
      episodes: [
        { id: 'ep-901', title: 'First Galaxies at the Dawn of Time', duration: 2350, durationStr: '39:10', releaseDate: '2024-01-28', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', description: 'How infrared observations revealed massive luminous galaxies forming mere hundreds of millions of years after the Big Bang.' },
        { id: 'ep-902', title: 'What Happens Inside an Event Horizon?', duration: 2480, durationStr: '41:20', releaseDate: '2024-02-18', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', description: 'General relativity vs quantum mechanics: Testing the boundaries of spacetime physics.' },
        { id: 'ep-903', title: 'Water Worlds in Trappist-1', duration: 2190, durationStr: '36:30', releaseDate: '2024-03-05', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', description: 'Investigating atmospheric biosignatures on temperate terrestrial planets orbiting red dwarf stars.' }
      ]
    },
    {
      id: 'pod-10',
      ...
      followers: '450,000',
      episodes: [
        { id: 'ep-1001', title: 'The Grid Battery Revolution', duration: 1980, durationStr: '33:00', releaseDate: '2024-02-08', episodeNumber: 1, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', description: 'Sodium-ion and iron-air storage facilities stabilizing solar and wind renewable grids.' },
        { id: 'ep-1002', title: 'Reforestation via Autonomous Seed Drones', duration: 1840, durationStr: '30:40', releaseDate: '2024-02-22', episodeNumber: 2, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', description: 'Planting thousands of native saplings per hour in remote mountain terrain using computer vision.' },
        { id: 'ep-1003', title: 'Deep Geothermal: Tapping the Earth’s Core', duration: 2050, durationStr: '34:10', releaseDate: '2024-03-07', episodeNumber: 3, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', description: 'Drilling miles beneath tectonic plates to generate infinite baseload clean electricity.' }
      ]
    }
  ];

  // 7. SEED AUDIOBOOKS (10 Audiobooks)
  const audiobooks = [
    {
      id: 'ab-1',
      ...
      chapters: [
        { number: 1, title: 'Prologue: The Forgotten Frequency', duration: '45 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3' },
        { number: 2, title: 'Chapter 1: The Observatory on Triton', duration: '52 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3' },
        { number: 3, title: 'Chapter 2: The Starlight Beacon', duration: '48 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3' },
        { number: 4, title: 'Chapter 3: Crossing the Helix Void', duration: '56 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3' }
      ]
    },
    {
      id: 'ab-2',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: The Attention Economy Trap', duration: '38 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3' },
        { number: 2, title: 'Chapter 2: The 90-Minute Focus Rhythm', duration: '42 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3' },
        { number: 3, title: 'Chapter 3: Engineering a Sanctuary of Calm', duration: '45 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3' }
      ]
    },
    {
      id: 'ab-3',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: The Midnight Bell', duration: '48 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3' },
        { number: 2, title: 'Chapter 2: The Alchemist’s Testament', duration: '51 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3' },
        { number: 3, title: 'Chapter 3: Echoes Under the Pavement', duration: '49 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3' }
      ]
    },
    {
      id: 'ab-4',
      ...
      category: 'Philosophy',
      chapters: [
        { number: 1, title: 'Chapter 1: What is in Your Control', duration: '40 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3' },
        { number: 2, title: 'Chapter 2: The Obstacle is the Way', duration: '44 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3' }
      ]
    },
    {
      id: 'ab-5',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: The Rain in Shinjuku', duration: '46 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3' },
        { number: 2, title: 'Chapter 2: The Encrypted Chip', duration: '50 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3' }
      ]
    },
    {
      id: 'ab-6',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: The Hallmarks of Aging', duration: '52 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3' },
        { number: 2, title: 'Chapter 2: Caloric Restriction Mimetics', duration: '48 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3' }
      ]
    },
    {
      id: 'ab-7',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: Winter on the Archipelago', duration: '50 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3' },
        { number: 2, title: 'Chapter 2: The Ice Road', duration: '55 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3' }
      ]
    },
    {
      id: 'ab-8',
      ...
      category: 'Business',
      chapters: [
        { number: 1, title: 'Chapter 1: The Non-Obvious Insight', duration: '42 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3' },
        { number: 2, title: 'Chapter 2: The Distribution Flywheel', duration: '46 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3' }
      ]
    },
    {
      id: 'ab-9',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: Midnight on 52nd Street', duration: '44 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3' },
        { number: 2, title: 'Chapter 2: The Cotton Club Sessions', duration: '48 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3' }
      ]
    },
    {
      id: 'ab-10',
      ...
      chapters: [
        { number: 1, title: 'Chapter 1: The Resonance of Carnac', duration: '50 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3' },
        { number: 2, title: 'Chapter 2: Gothic Vaults & Organ Reverbs', duration: '54 mins', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3' }
      ]
    }
  ];
  ...
  MemoryStore.artists = artists;
  MemoryStore.songs = songs;
  MemoryStore.albums = albums;
  MemoryStore.playlists = playlists;
  MemoryStore.podcasts = podcasts;
  MemoryStore.audiobooks = audiobooks;

  // Also populate MongoDB if connected
  if (!isMemoryMode()) {
    try {
      await MgUser.deleteMany({});
      await MgUser.insertMany(users);

      await MgArtist.deleteMany({});
      await MgArtist.insertMany(artists);

      await MgSong.deleteMany({});
      await MgSong.insertMany(songs);

      await MgAlbum.deleteMany({});
      await MgAlbum.insertMany(albums);

      await MgPlaylist.deleteMany({});
      await MgPlaylist.insertMany(playlists);

      await MgPodcast.deleteMany({});
      await MgPodcast.insertMany(podcasts);

      await MgAudiobook.deleteMany({});
      await MgAudiobook.insertMany(audiobooks);

      console.log('✅ Seeded MongoDB successfully!');
    } catch (e) {
      console.warn('MongoDB insertion error (operating in-memory):', e);
    }
  }

  console.log(`✅ Loaded ${songs.length} Songs, ${artists.length} Artists, ${albums.length} Albums, ${playlists.length} Playlists, ${podcasts.length} Podcasts, and ${audiobooks.length} Audiobooks!`);
};
